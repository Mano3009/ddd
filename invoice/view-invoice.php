...
<div class="card">
<h5 class="card-header text-center">View Invoice</h5>
<div class="card-body">
...
<?php
$selectcus="SELECT * FROM `invoice` ORDER BY id DESC";
...
<td><?php echo $row_cus['paidamount']; ?></td> 
<td><div class="btn-group">    
<a  href="<?php echo $baseurl; ?>invoice/invoice-bill-pdf.php?invoiceupid=<?php echo $row_cus['id']; ?>"><button class="btn btn-sm btn-outline-light"><i class="fas fa-eye"></i></button></a>
	<a  href="<?php echo $baseurl; ?>invoice/update-invoice.php?invoiceupid=<?php echo $row_cus['id']; ?>"><button class="btn btn-sm btn-outline-light"><i class="fas fa-pencil-alt"></i></button></a>
</div></td>    
</tr>
 <?php
$i++;    
